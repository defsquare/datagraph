...
[root README](../../README.md) for the full
...
build + index; see the [root README](../../README.md#config-ids-refs-groups).
...
[core README's Aggregates section](../core/README.md#aggregates)
